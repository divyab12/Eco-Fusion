...
- (void)drawTextInRect:(CGRect)rect 
{
    ...
    for (int i = 0; i < numLines; i++) {        
        ...
        switch (_verticalAlignment) {
            case SIULabelVerticalAlignmentTop:
            {
                drawY = i * _lineHeight;
            }
                break;
            case SIULabelVerticalAlignmentMiddle:
            {
                if(i > 0) {
                    drawY += _lineHeight;            
                }
                ...
                break;
            case SIULabelVerticalAlignmentBottom:
            {
...
- (void)setup {
    ...
    _verticalAlignment = SIULabelVerticalAlignmentMiddle;
}
