...
//
//***********************************************************************
// NON ARC, add -fno-objc-arc in, Targets/ Build Phases/ Compiled Sources
//                  MAKE SURE TO RELEASE/DEALLOC
//***********************************************************************
...
- (void)drawRect:(CGRect)rect {
	...
	int r = (self.frame.size.width>self.frame.size.height?self.frame.size.height:self.frame.size.width)/2 * 0.7;
