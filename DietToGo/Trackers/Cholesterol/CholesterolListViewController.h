//
//  CholesterolListViewController.h
//  EHEandme
//
...
@interface CholesterolListViewController : GAITrackedViewController<PickerViewControllerDelegate>{
    /**
...
@property (weak, nonatomic) IBOutlet UILabel *mMgLbl;
@property (weak, nonatomic) IBOutlet UIImageView *mCholesterolimgView;
@property (weak, nonatomic) IBOutlet UILabel *mCholeslbl;
